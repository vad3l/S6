...
yy_symbol_value_print (FILE *yyo,
                       yysymbol_kind_t yykind, YYSTYPE const * const yyvaluep, struct ast *ret)
{
  FILE *yyoutput = yyo;
  YY_USE (yyoutput);
  YY_USE (ret);
                 ...
                 yysymbol_kind_t yykind, YYSTYPE const * const yyvaluep, struct ast *ret)
{
  ...
  yy_symbol_value_print (yyo, yykind, yyvaluep, ret);
  YYFPRINTF (yyo, ")");
}
...
yydestruct (const char *yymsg,
            yysymbol_kind_t yykind, YYSTYPE *yyvaluep, struct ast *ret)
{
  YY_USE (yyvaluep);
  YY_USE (ret);
  if (!yymsg)
  ...
  for (;;)
    {
      ...
      yydestruct ("Error: popping",
                  YY_ACCESSING_SYMBOL (yystate), yyvsp, ret);
      YYPOPSTACK (1);
      yystate = *yyssp;
      YY_STACK_PRINT (yyss, yyssp);
    }
  ...
  while (yyssp != yyss)
    {
      yydestruct ("Cleanup: popping",
                  YY_ACCESSING_SYMBOL (+*yyssp), yyvsp, ret);
      YYPOPSTACK (1);
    }
#ifndef yyoverflow
  if (yyss != yyssa)
